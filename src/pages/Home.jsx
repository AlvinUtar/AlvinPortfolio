...
const CanvasErrorFallback = ({ error }) => (
  <div className="w-full h-screen flex items-center justify-center">
    <div className="text-center">
      <h2 className="text-xl font-bold">Error loading 3D scene:</h2>
      <p>{error.message}</p>
    </div>
  </div>
);

const Scene = ({ isRotating, islandPosition, islandScale, islandRotation, setIsRotating, setCurrentStage, planeScale, planePosition }) => {
  return (
    <>
